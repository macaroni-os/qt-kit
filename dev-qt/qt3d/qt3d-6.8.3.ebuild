...
DESCRIPTION="Qt 3D provides a fully configurable renderer that enables developers to quickly implement any rendering pipeline that they need"
...
RDEPEND="
	...
	~dev-qt/qtbase-${PV}:6[gles2-only,gui,vulkan]
